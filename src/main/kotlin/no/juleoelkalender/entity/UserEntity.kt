...
class UserEntity(
    ...
    @Basic @Column(name = "locked", nullable = false) var locked: Boolean = false,
    ...
    @ManyToMany(fetch = FetchType.LAZY) @JoinTable(
        ...
        inverseJoinColumns = [JoinColumn(name = "calendar_token_id")]
    ) var calendarToken: MutableSet<CalendarTokenEntity>,
